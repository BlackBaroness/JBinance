...
import com.github.blackbaroness.jbinance.security.AuthenticationInterceptor;
...
public class BinanceApiServiceGenerator {
    ...
    public static <S> S createService(Class<S> serviceClass, String apiKey, String secret) {
        String baseUrl;
        if (!BinanceApiConfiguration.useTestnet) {
            baseUrl = BinanceApiConfiguration.getApiBaseUrl();
        } else {
            baseUrl = /*BinanceApiConfig.useTestnetStreaming ?
                BinanceApiConfig.getStreamTestNetBaseUrl() :*/
                    BinanceApiConfiguration.getTestNetBaseUrl();
        }
